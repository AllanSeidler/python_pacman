...
fontes = pygame.font.SysFont('arial', 24, True, False)
...
class Cenario(ElementoJogo):
    ...
    def pintar_score(self, tela):
        ...
        img_pontos = fontes.render('Score: {}'.format(self.pontos), True, AMARELO)
        img_vidas = fontes.render('Vidas: {}'.format(self.vidas), True, AMARELO)
    ...
    def pintar_texto_centro(self, tela, texto):
        texto_img = fontes.render(texto, True, AMARELO)
    ...
    def pintar_vitoria(self, tela):
        self.pintar_texto_centro(tela, 'V O C Ê     V E N C E')
...
class Pacman(ElementoJogo, Movivel):
    ...
    def processar_eventos_mouse(self, evts):
        delay = 50
        for e in evts:
